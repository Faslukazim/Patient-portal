    ...
    <div class="flex max-w-6xl h-full mt-28 shadow-sm border border-gray-50 rounded-md">
      <div class="flex-1 overflow-auto p-5">
        ...
        <div class="mt-5 flex gap-3 overflow-x-auto scrollbar-hide">
          <div v-for="Department in specializationList" :key="Department.department" :class="[
            'cursor-pointer p-2 flex-shrink-0 items-center flex justify-center w-fit text-gray-800 font-medium text-base shadow-sm hover:bg-gray-100 bg-gray-50 rounded-md transition-transform hover:scale-95',
            {
      ...
      <div :class="[
            ...
            booking
              ...
              : 'opacity-80 pointer-events-none scale-90',
          ]">
