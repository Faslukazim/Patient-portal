...
watch(selectedDepartment, (newVal) => {
    if (newVal) {
        ...
        PractResource.list.fetch().then(() => {
            console.log('Fetched PractList:', PractList.value) // Log for debugging
        })
    }
})
...
function selectDepartment(department) {
    ...
    console.log('Selected Department:', selectedDepartment.value) // Log for debugging
}

function selectDoctor(doctorName) {
    selectedDoctor.value = doctorName
    console.log('Selected Doctor:', selectedDoctor.value) // Log for debugging
}

function bookAppointment() {
    console.log('Booking Appointment with Department:', selectedDepartment.value)
    console.log('Booking Appointment with Doctor:', selectedDoctor.value)
    booking.value = true
